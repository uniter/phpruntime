...
module.exports = function (internals) {
    ...
    return {
         ...
         */
        'php_uname': internals.typeFunction(
         ...
         */
        'phpversion': internals.typeFunction(
            '?string $extension = null : mixed',
            function (extensionNameValue) {
                // FIXME: Use union return type above once supported.
                var extensionName = extensionNameValue.getNative();
         ...
         * It is required by some scripts though (e.g. Zend's test runner `run-tests.php` script),
         ...
         */
        'zend_version': internals.typeFunction(': string', function () {
            return valueFactory.createString(
