...
describe('PHP debugger breakpoint integration', function () {
    it('should support pausing at a breakpoint defined for the session and then later resuming', function () {
        var php = nowdoc(function () {/*<<<EOS
<?php

log('first');

// Split across several lines to test line breakpoint handling
log(
    'second'
);
...
*/;}), //jshint ignore:line
        ...
        return engine.execute().then(function () {
            expect(log).to.deep.equal([
                'log() :: first',
                'breakpoint hit, execution paused... :: /my/debuggable/script.php@6:1-8:3',
