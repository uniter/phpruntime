...
describe('PHP "is_file" builtin function', function () {
    beforeEach(function () {
        ...
        this.is_file = this.filesystemFunctions.is_file;
        ...
        this.callIsFile = function () {
            return this.is_file.apply(null, this.args);
        }.bind(this);
    });
    ...
    it('should return true when a file exists with the given path', function () {
        ...
        expect(this.callIsFile()).to.be.an.instanceOf(BooleanValue);
        expect(this.callIsFile().getNative()).to.be.true;
    });

    it('should return false when no file but a directory exists with the given path', function () {
        ...
        expect(this.callIsFile()).to.be.an.instanceOf(BooleanValue);
        expect(this.callIsFile().getNative()).to.be.false;
    });
